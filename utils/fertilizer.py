fertilizer_dic = {
    ...
    <br/> Please consider the following suggestions:
    <br/><br/> 1. <i>Add sawdust or fine woodchips to your soil</i> – the carbon in the sawdust/woodchips loves nitrogen and will help absorb and soak up any excess nitrogen.
    <br/>2. <i>Plant heavy nitrogen-feeding plants</i> – tomatoes, corn, broccoli, cabbage, and spinach are examples of plants that thrive off nitrogen and will absorb it from the soil.
    ...
    <br/>4. <i>Sugar</i> – In limited studies, it was shown that adding sugar to your soil can help potentially reduce the amount of nitrogen in your soil. Sugar is partially composed of carbon, an element that attracts and soaks up nitrogen. This is a similar concept to adding sawdust/woodchips which are high in carbon content.
    ...
    <br/>8. <i>Do nothing</i> – If you already have plants that are producing lots of foliage, it may be best to let them continue to absorb all the nitrogen to amend the soil for your next crops.""",

    'PHigh': """The P value of your soil is high.
    <br/> Please consider the following suggestions:
    <br/><br/>1. <i>Avoid adding manure</i> – manure contains many key nutrients for your soil but typically includes high levels of phosphorous. Limiting the addition of manure will help reduce phosphorus being added.
    ...
    <br/>6. <i>Clay soil</i> – introducing clay particles into your soil can help retain and fix phosphorus deficiencies.
    ...
    <br/>9. If pH is high, the addition of an appreciable amount of organic matter will help acidify the soil. The application of acidifying fertilizers, such as ammonium sulfate, can help lower soil pH""",
    ...
    <br/>2. <i>Sift through the soil</i> and remove as many rocks as possible, using a soil sifter. Minerals occurring in rocks such as mica and feldspar slowly release potassium into the soil through weathering.
    ...
    <br/>4. Mix crushed eggshells, crushed seashells, wood ash, or soft rock phosphate into the soil to add calcium. Mix in up to 10 percent of organic compost to help amend and balance the soil.
